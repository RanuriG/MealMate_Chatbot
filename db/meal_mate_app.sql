CREATE DATABASE  IF NOT EXISTS `meal_mate_app` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `meal_mate_app`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: meal_mate_app
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Spaghetti Carbonara',10.00),(2,'Penne Arrabbiata',9.00),(3,'Fettuccine Alfredo',11.00),(4,'Linguine with Pesto Sauce',10.00),(5,'Rigatoni Bolognese',12.00),(6,'Classic Cheeseburger',8.00),(7,'BBQ Bacon Burger',9.00),(8,'Mushroom Swiss Burger',9.50),(9,'Chocolate Milkshake',6.00),(10,'Vanilla Milkshake',6.00),(11,'Strawberry Milkshake',6.00),(12,'French Fries',4.00),(13,'Hot and Spicy Chicken Wings',8.00),(14,'Garlic Bread',5.00);
...
--
-- Dumping routines for database 'meal_mate_app'
--
